var budgetController = (function() {
    ...
    return {
        ...
        calculateBudget: function() {
            ...
            //calculate the percentage of incoem that we spent
...
var UIController = (function() {
    ...
    var formatNumber = function(num, type) {
        ...
        int = numSplit[0];
        if(int.length > 3){
          int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, 3); //input 2310 oputput 2,310
        }
